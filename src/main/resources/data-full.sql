...
-- ======================================================================
-- Note: Using existing categories from migration (Fiction=1, Mystery & Thriller=3, etc.)
-- TEMPORARILY COMMENTED OUT TO DEBUG CATEGORY ISSUE

-- Let's first check what categories exist by running without books
...
-- ('The Secret History', 'Donna Tartt', '9780140167771', 'A haunting tale of six classics students at an elite Vermont college whose lives are forever changed by a murder. This dark academia masterpiece explores themes of morality, beauty, and the corruption of innocence.', 1992, 'Vintage Books', 559, 1, 'https://images.example.com/secret-history.jpg', '2024-01-15 10:15:00', '2024-01-15 10:15:00');
...
('Meditations', 'Marcus Aurelius', '9780140449334', 'The personal writings of the Roman Emperor Marcus Aurelius, offering insights into Stoic philosophy and practical wisdom for daily life. A cornerstone of philosophical literature.', 180, 'Penguin Classics', 254, 9, 'https://images.example.com/meditations.jpg', '2024-01-15 12:15:00', '2024-01-15 12:15:00'),
...
('The Diary of a Young Girl', 'Anne Frank', '9780553577129', 'The poignant diary of Anne Frank, a Jewish girl hiding from the Nazis in Amsterdam. A powerful testament to the human spirit and the horrors of the Holocaust.', 1947, 'Bantam', 283, 7, 'https://images.example.com/anne-frank.jpg'),

('Long Walk to Freedom', 'Nelson Mandela', '9780316548182', 'Mandela''s autobiography chronicling his journey from rural childhood to becoming South Africa''s first Black president. An inspiring story of resilience and social justice.', 1994, 'Little, Brown and Company', 656, 7, 'https://images.example.com/long-walk.jpg'),

-- Science Fiction & Fantasy
('Dune', 'Frank Herbert', '9780441172719', 'An epic science fiction novel set on the desert planet Arrakis, following Paul Atreides as he becomes embroiled in a struggle for control of the universe''s most valuable resource.', 1965, 'Ace Books', 688, 4, 'https://images.example.com/dune.jpg'),

('The Left Hand of Darkness', 'Ursula K. Le Guin', '9780441478125', 'A groundbreaking science fiction novel exploring gender, politics, and human nature through the story of an envoy on a planet where people are ambisexual.', 1969, 'Ace Books', 304, 4, 'https://images.example.com/left-hand-darkness.jpg');
...
INSERT INTO book_ratings (user_id, book_id, rating, review, created_at) VALUES
-- Alice Scholar's ratings
(2, 1, 5, 'A masterpiece of contemporary literature. Tartt\'s prose is rich and immersive, and the characters are unforgettably complex. The way she explores themes of beauty, morality, and the corruption of innocence is brilliant. This book stayed with me long after I finished it.', '2024-02-20 10:30:00'),
(2, 5, 5, 'Wilde\'s only novel is a perfect blend of wit, philosophy, and gothic horror. The dialogue sparkles with his characteristic humor, while the underlying themes about aestheticism and moral decay are deeply thought-provoking. A timeless classic.', '2024-03-22 16:45:00'),
(2, 10, 4, 'Essential reading for anyone interested in Stoic philosophy. Marcus Aurelius writes with honesty and humility about the human condition. Some passages require multiple readings to fully appreciate, but the wisdom is invaluable.', '2024-04-27 18:00:00'),

-- Benjamin Reader's ratings
(3, 2, 4, 'Rio captures the intensity and competitiveness of drama school perfectly. The Shakespeare references add wonderful depth to the story, and the mystery keeps you guessing until the end. Well-crafted characters and atmospheric setting.', '2024-03-10 21:15:00'),
(3, 6, 4, 'Clever premise and engaging characters. Osman writes with humor and warmth while still delivering a solid mystery. The elderly protagonists are refreshing and their friendship is heartwarming. Looking forward to the sequel.', '2024-06-30 14:20:00'),

-- Charlotte Novelist's ratings
(4, 4, 5, 'Kuang\'s exploration of colonialism through the lens of translation and language is brilliant. The academic setting feels authentic, and the magical realism elements enhance rather than overshadow the serious themes. Beautifully written and important.', '2024-08-25 20:45:00'),
(4, 7, 5, 'Jenkins Reid has crafted a compelling story about ambition, love, and the price of fame. Evelyn Hugo is a complex, fascinating character, and the mystery of why she chose Monique unfolds perfectly. Couldn\'t put it down.', '2024-09-20 23:30:00'),
(4, 9, 5, 'Absolutely stunning prose. Doerr weaves together two parallel stories with incredible skill, creating a narrative that is both heartbreaking and beautiful. The way he writes about light and perception is particularly moving.', '2024-06-07 22:00:00'),

-- David Historian's ratings
(5, 8, 5, 'An epic novel that does justice to its historical setting. Orringer\'s research is meticulous, and her character development is exceptional. The way she portrays the slide from normalcy into horror is both subtle and devastating.', '2024-07-17 21:45:00'),
(5, 12, 4, 'Harari makes complex historical and anthropological concepts accessible to general readers. His perspective on human development is thought-provoking, though some conclusions could be better supported. Still, an engaging and educational read.', '2024-05-30 16:20:00'),
(5, 17, 5, 'Mandela\'s autobiography is both inspiring and educational. His journey from rural childhood to presidency is remarkable, and his reflections on forgiveness and reconciliation are particularly powerful. Essential reading for understanding 20th-century history.', '2024-09-12 18:30:00'),

-- Emily Philosopher's ratings
(6, 10, 5, 'A cornerstone of Stoic philosophy that remains remarkably relevant. Marcus Aurelius writes with humility and practical wisdom about duty, virtue, and accepting what we cannot control. I return to this book regularly for guidance.', '2024-04-12 17:45:00'),
(6, 11, 4, 'Camus\' exploration of the absurd is both challenging and liberating. His argument about finding meaning through struggle rather than hope is thought-provoking. The writing is clear and accessible despite the complex philosophical concepts.', '2024-05-27 20:15:00'),
(6, 15, 4, 'Revolutionary perspective on visual culture and art criticism. Berger effectively challenges the traditional Western approach to viewing art. Some arguments could be stronger, but overall a important and influential work.', '2024-08-07 14:20:00'),

-- Frank Scientist's ratings
(7, 13, 5, 'Foundational work in biology that changed our understanding of life itself. Darwin\'s clear reasoning and methodical presentation of evidence is exemplary scientific writing. Still relevant and readable today.', '2024-06-03 19:45:00'),
(7, 14, 5, 'Carson\'s work is both scientifically rigorous and beautifully written. Her ability to explain complex ecological concepts while maintaining poetic beauty is remarkable. This book truly launched the modern environmental movement.', '2024-07-10 16:00:00'),
(7, 12, 4, 'Excellent synthesis of human history from scientific and anthropological perspectives. Harari\'s writing is engaging and accessible. Some generalizations are broad, but overall provides valuable insights into human development.', '2024-09-02 21:00:00');
